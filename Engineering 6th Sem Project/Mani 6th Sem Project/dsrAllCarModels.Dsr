VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} dsrCarModels 
   Bindings        =   "dsrAllCarModels.dsx":0000
   Caption         =   "DataReport1"
   ClientHeight    =   8505
   ClientLeft      =   60
   ClientTop       =   435
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         EndProperty
         ForeColor       =   4210688
         Object.Caption         =   "Car Models Details"
         Alignment       =   2
      EndProperty
   EndProperty
   SectionCode1    =   2
   ...
   EndProperty
End
Attribute VB_Name = "dsrCarModels"
