...
txtOdate.Text = Format(Now, "dd-mmm-yy")
Dim RsC As New ADODB.Recordset
RsC.Open "select * from cust", Cn, adOpenStatic
cmbCustId.CLEAR
If RsC.EOF = True And RsC.BOF = True Then
MsgBox "You should have some cust"
...
RsC.MoveFirst
While Not RsC.EOF
cmbCustId.AddItem RsC.Fields(0)
RsC.MoveNext
Wend
...
Cmd.CommandText = "insert into order_tab values(" & txtOno.Text & ",'" & txtOdate.Text & "','" & cmbCustId.Text & "'," & txtOamt.Text & ")"
...
Cstring = "delete from order_tab where order_no=" & txtOno.Text
...
txtOno.Locked = True
txtOno.BackColor = vbWhite
txtOdate.Text = Format(txtOdate.Text, "dd-mmm-yy")

Case 4
'Update
Cmd.ActiveConnection = Cn

Cstring = "update order_tab set odate ='" & txtOdate.Text & "',cust='" & cmbCustId.Text & "',order_amt=" & txtOamt.Text & " where order_no=" & txtOno.Text
Cmd.CommandText = Cstring
MsgBox Cmd.CommandText
Cmd.Execute
Saved = True
...
rs1.Open "select * from ORDER_TAB", Cn, adOpenDynamic
Saved = True
loaded = False
Screen.MousePointer = 99
Screen.MouseIcon = LoadPicture(App.Path & "\Themes\" & theme & "\Cursors\Arrow.cur")
...
txtOno.Text = DRS.Fields(0)
Else
txtOno.Text = ""
End If

If Not IsNull(DRS.Fields(1)) Then
txtOdate.Text = DRS.Fields(1)
txtOdate.Text = Format(txtOdate.Text, "dd-mmm-yy")
Else
txtOdate.Text = ""
End If
...
cmbCustId.AddItem DRS.Fields(2)
cmbCustId.Text = cmbCustId.List(0)
End If

If Not IsNull(DRS.Fields(3)) Then
txtOamt.Text = DRS.Fields(3)
Else
txtOamt.Text = ""
End If
