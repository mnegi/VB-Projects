...
rsD.Open "select * from loan", Cn, adOpenStatic
...
Cmd.CommandText = "insert into borrower values(" & cmbAcc.Text & "," & cmbCust.Text & ")"
...
Cstring = "delete from borrower where accno=" & txtAccNo.Text & "and cust_id=" & cmbCust.Text
