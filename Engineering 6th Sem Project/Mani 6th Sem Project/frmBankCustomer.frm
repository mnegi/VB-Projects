...
Begin VB.Form frmBankCustomer 
   ...
   Begin VB.Label lblTitle 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Bank Customer Database"
      BeginProperty Font 
         Name            =   "Times New Roman"
         Size            =   11.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmBankCustomer"
...
Screen.MousePointer = 99
Screen.MouseIcon = LoadPicture(App.Path & "\Themes\" & theme & "\Cursors\Arrow.cur")
Me.Caption = "Bank Customer Database"
...
Sub DeleteRecord()
Cmd.ActiveConnection = Cn
Cmd.CommandText = "delete from customer where cust_id = " & txtDriverId.Text
Cmd.Execute
'MsgBox "deleted"
rs.Close
Call UpdateTreeView(cmbSort.Text, cmbSortOrder.Text)
...
CmdText = "insert into customer values(" & txtDriverId.Text & ",'" & txtFname.Text & "','" & txtMname.Text & "','" & txtLname.Text & "','" & cmbGender.Text & "','" & mskDob.Text & "','" & txtAddress.Text & "','" & txtCity.Text & "','" & cmbDist.Text & "','" & cmbStates.Text & "','" & txtPin.Text & "','" & txtPhone.Text & "','" & photoDisPath & "')"
...
If Not MyFile.FolderExists(App.Path & "\Common\Images\OrderCustomers") Then
    MyFile.CreateFolder (App.Path & "\Common\Images\OrderCustomers")
End If

If MyFile.FileExists(App.Path & "\Common\Images\OrderCustomers\" & CommonDialog1.FileTitle) Then
    'do nothing
Else
If CommonDialog1.Filename <> "" Then
    MyFile.CopyFile CommonDialog1.Filename, App.Path & "\Common\Images\OrderCustomers\" & CommonDialog1.FileTitle
End If
End If
...
photoDisPath = App.Path & "\common\images\OrderCustomers\" & CommonDialog1.FileTitle
End If
End Sub
Sub RemovePhoto()
...
Cmd.ActiveConnection = Cn
Cmd.CommandText = "select * from customer where " & cmbSearch.Text & "='" & srchText & "'"
...
rsD.Source = "select * from customer order by CUST_ID"
...
Cmd.ActiveConnection = Cn
Cmd.CommandText = "select * from customer order by " & a & " " & b
Set rs = Cmd.Execute
...
'rs.Close
Cmd.ActiveConnection = Cn
Cmd.CommandText = "select * from customer where cust_id = " & Node.Text
...
'MsgBox "Updated"
'********************************************
If ManiExtras1.FileExists(App.Path & "\common\images\OrderCustomers\" & CommonDialog1.FileTitle) Then
'do nothing
Else
Call ManiExtras1.Copy_File(CommonDialog1.Filename, App.Path & "\common\images\OrderCustomers\")
End If

Cmd.ActiveConnection = Cn
Cmd.CommandText = "update customer set fname = '" & txtFname.Text & "',lname = '" & txtLname.Text & "',mname = '" & txtMname.Text & "',sex = '" & cmbGender.Text & "',dob = '" & mskDob.Text & "',distt = '" & cmbDist.Text & "',state = '" & cmbStates.Text & "',address = '" & txtAddress.Text & "',city = '" & txtCity.Text & "',pin = '" & txtPin.Text & "',phone = '" & txtPhone.Text & "',photo = '" & photoDisPath & "' where cust_id = " & txtDriverId.Text
Cmd.Execute
MsgBox "updated"
...
Cmd.ActiveConnection = Cn
Cmd.CommandText = "select * from customer where " & cmbSearch.Text & " like '" & txtSearch.Text & "%'"
...
Cmd.ActiveConnection = Cn
Cmd.CommandText = "select * from customer where cust_id=" & DId
