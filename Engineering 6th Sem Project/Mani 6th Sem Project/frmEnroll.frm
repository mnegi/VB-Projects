...
cmbRegno.CLEAR
rsD.Open "select * from student", Cn, adOpenStatic
If Not (rsD.EOF = True And rsD.BOF = True) Then
rsD.MoveFirst
While Not rsD.EOF
cmbRegno.AddItem rsD.Fields(0)
rsD.MoveNext
Wend
rsD.Close
End If
...
Cmd.CommandText = "insert into enroll values('" & cmbRegno.Text & "'," & cmbCourse.Text & "," & cmbSem.Text & "," & txtMarks.Text & ")"
...
Cstring = "delete from enroll where regno='" & cmbRegno.Text & "' and course=" & cmbCourse.Text & " and sem=" & cmbSem.Text
...
cmbRegno.Locked = True
cmbRegno.BackColor = vbWhite
...
Cstring = "update enroll set marks =" & txtMarks.Text & " where regno='" & cmbRegno.Text & "' and course=" & cmbCourse.Text & " and sem=" & cmbSem.Text
Cmd.CommandText = Cstring
MsgBox Cmd.CommandText
Cmd.Execute
Saved = True
...
rs1.Open "select * from enroll", Cn, adOpenDynamic
Saved = True
loaded = False
Screen.MousePointer = 99
Screen.MouseIcon = LoadPicture(App.Path & "\Themes\" & theme & "\Cursors\Arrow.cur")

Me.Caption = "EnrollMent DataBase"
