...
Begin VB.Form frmAccount 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbBranch 
         ...
         Width           =   3435
      End
      Begin XPTEXTBOX.text txtAccNo 
         Height          =   420
         Left            =   2250
         TabIndex        =   14
         Tag             =   "1"
         ToolTipText     =   "Enter the account number"
         Top             =   240
         Width           =   3435
         _ExtentX        =   6059
         _ExtentY        =   741
         ...
         EndProperty
      End
      Begin XPTEXTBOX.text txtBalance 
         Height          =   420
         Left            =   2220
         TabIndex        =   18
         Tag             =   "1"
         ToolTipText     =   "Enter the balance"
         Top             =   1875
         Width           =   3435
         _ExtentX        =   6059
         _ExtentY        =   741
...
Cmd.CommandText = "insert into account values(" & txtAccNo.Text & ",'" & cmbBranch.Text & "'," & txtBalance.Text & ")"
...
Cstring = "delete from account where accno=" & txtAccNo.Text
...
Cstring = "update accout set account_name='" & cmbBranch.Text & "',balance=" & txtBalance.Text & " where accno=" & txtAccNo.Text
Cmd.CommandText = Cstring
MsgBox Cmd.CommandText
Cmd.Execute
Saved = True
