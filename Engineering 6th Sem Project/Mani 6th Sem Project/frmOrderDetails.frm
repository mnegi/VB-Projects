...
Begin VB.Form frmOrderDetails 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin XPTEXTBOX.text txtQty 
         ...
         TabIndex        =   3
         Tag             =   "1"
         ToolTipText     =   "Enter quantity here"
         Top             =   1920
         Width           =   3435
         _ExtentX        =   6059
         _ExtentY        =   741
         ...
         EndProperty
      End
      Begin XPTEXTBOX.text txtOrderNo 
         Height          =   420
         Left            =   2235
         TabIndex        =   1
         Tag             =   "1"
         ToolTipText     =   "Enter the order number."
         Top             =   300
         Width           =   3435
         _ExtentX        =   6059
         _ExtentY        =   741
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmOrderDetails.frx":000C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmOrderDetails.frx":0028
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmOrderDetails.frx":0044
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmOrderDetails.frx":0060
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmOrderDetails.frx":007C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmOrderDetails.frx":0098
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmOrderDetails.frx":00B4
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmOrderDetails.frx":00D0
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmOrderDetails.frx":00EC
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmOrderDetails.frx":0108
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmOrderDetails.frx":0124
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.Label lblTitle 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Order Details Database"
      BeginProperty Font 
         Name            =   "Times New Roman"
         Size            =   11.25
         Charset         =   0
...
rsD.Open "select * from catalog", Cn, adOpenStatic
If Not (rsD.EOF = True And rsD.BOF = True) Then
rsD.MoveFirst
While Not rsD.EOF
cmbBookId.AddItem rsD.Fields(0)
rsD.MoveNext
Wend
rsD.Close
End If
...
Cmd.CommandText = "insert into order_details values(" & txtOrderNo.Text & "," & cmbBookId.Text & "," & txtQty.Text & ")"
...
Cstring = "delete from order_details where oder_no=" & txtOrderNo.Text & " and book_id=" & cmbBookId.Text
...
Cstring = "update order_details set qty =" & txtQty.Text & " where oder_no=" & txtOrderNo.Text & " and book_id=" & cmbBookId.Text
Cmd.CommandText = Cstring
MsgBox Cmd.CommandText
Cmd.Execute
Saved = True
...
rs1.Open "select * from order_details", Cn, adOpenDynamic
Saved = True
loaded = False
Screen.MousePointer = 99
Screen.MouseIcon = LoadPicture(App.Path & "\Themes\" & theme & "\Cursors\Arrow.cur")

Me.Caption = "Order Detail DataBase"
...
cmbBookId.AddItem DRS.Fields(1)
cmbBookId.Text = cmbBookId.List(0)
End If
