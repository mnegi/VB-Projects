Attribute VB_Name = "basDataIntoFlexGrid"
'****************************************************
...
'                                                   *
'   THIS MODULE IS TO READ FROM A RECORDSET, AND    *
'   DISPLAY THE DATA IN MS FLEX GRID CONTROL. IT    *
'   AUTOSIZES THE FIELDS IN GRID BASED ON THE MAX   *
'   LENGTH OF THE FILED IN ANY RECORD.              *
'                                                   *
'****************************************************
...
Private Sub HighlightGridRow(grd As MSFlexGrid, iRow As Long)
    ...
    End With
End Sub
Public Sub LoadRecordsetIntoGrid(rs As ADODB.Recordset, grd As MSFlexGrid, _
