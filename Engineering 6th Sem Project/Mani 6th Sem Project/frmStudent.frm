...
End If
formactivated = True
'Set RS = db.OpenRecordset("select * from student", dbOpenDynamic, dbExecDirect, dbOptimistic)
End Sub
...
cmbSearch.AddItem "REGNO"
cmbSearch.AddItem "FNAME"
cmbSearch.AddItem "MNAME"
cmbSearch.AddItem "MAJOR"
...
cmbSort.AddItem "REGNO"
cmbSort.AddItem "FNAME"
cmbSort.AddItem "MNAME"
cmbSort.AddItem "MAJOR"
cmbSort.AddItem "SEX"
cmbSort.AddItem "DOB"
...
Sub DeleteRecord()
Cmd.ActiveConnection = Cn
Cmd.CommandText = "delete from student where REGNO = '" & txtDriverId.Text & "'"
Cmd.Execute
'MsgBox "deleted"
rs.Close
Call UpdateTreeView(cmbSort.Text, cmbSortOrder.Text)
...
CmdText = "insert into student values('" & txtDriverId.Text & "','" & txtFname.Text & "','" & txtMname.Text & "','" & txtLname.Text & "','" & cmbGender.Text & "','" & mskDob.Text & "','" & txtAddress.Text & "','" & txtCity.Text & "','" & cmbDist.Text & "','" & cmbStates.Text & "','" & txtPin.Text & "','" & txtPhone.Text & "','" & CommonDialog1.FileTitle & "')"
...
'rs.AddNew
'rs.Fields("REGNO") = txtDriverId.Text
...
Cmd.ActiveConnection = Cn
Cmd.CommandText = "select * from student where " & cmbSearch.Text & "='" & srchText & "'"
...
rsD.Source = "select * from student order by REGNO"
...
Set treenode = treePerson.Nodes.Add(, , "students", "student Database", "Close")
Cmd.ActiveConnection = Cn
Cmd.CommandText = "select * from student order by " & a & " " & b
Set rs = Cmd.Execute

'rs.Open "select * from student order by REGNO", Cn
...
While Not rs.EOF
    If rs.Fields("SEX") = "Male" Then
        Set treenode = treePerson.Nodes.Add("students", tvwChild, rs.Fields("REGNO"), rs.Fields("REGNO"), "Male")
    Else
        Set treenode = treePerson.Nodes.Add("students", tvwChild, rs.Fields("REGNO"), rs.Fields("REGNO"), "Female")
    End If
rs.MoveNext
...
Public Sub DISPLAY(DRS As ADODB.Recordset)
    ...
    txtDriverId.Text = DRS.Fields("REGNO")
...
'
'***************************************
If Node.Text = "student Database" Then
Else
If Node.Checked = True Then
'rs.Close
Cmd.ActiveConnection = Cn
Cmd.CommandText = "select * from student where REGNO = '" & Node.Text & "'"
...
lblDisplayName.Caption = txtFname.Text & " " & txtMname.Text
...
txtLname.Text = StrConv(txtLname.Text, vbUpperCase)
SendKeys "{END}"
End Sub
...
'Set rs1 = DB.OpenRecordset("select * from student where REGNO = '" & txtDriverId.Text & "' ", dbOpenDynamic, dbExecDirect, dbOptimistic)
''rs1.Delete
'MsgBox "deleted"
'rs1.AddNew
'MsgBox rs1.RecordCount
'rs1.Fields("REGNO") = txtDriverId.Text
...
Cmd.ActiveConnection = Cn
Cmd.CommandText = "update student set fname = '" & txtFname.Text & "',lname = '" & txtLname.Text & "',mname = '" & txtMname.Text & "',sex = '" & cmbGender.Text & "',dob = '" & mskDob.Text & "',distt = '" & cmbDist.Text & "',state = '" & cmbStates.Text & "',address = '" & txtAddress.Text & "',city = '" & txtCity.Text & "',pin = '" & txtPin.Text & "',phone = '" & txtPhone.Text & "',photo = '" & CommonDialog1.FileTitle & "' where REGNO = '" & txtDriverId.Text & "'"
Cmd.Execute
MsgBox "updated"
...
Cmd.ActiveConnection = Cn
Cmd.CommandText = "select * from student where " & cmbSearch.Text & " like '" & txtSearch.Text & "%'"
...
While Not rs1.EOF
    If rs1.Fields("SEX") = "Male" Then
        Set treenode = treePerson.Nodes.Add(, , rs1.Fields("REGNO"), rs1.Fields("REGNO"), "Male")
    Else
        Set treenode = treePerson.Nodes.Add(, , rs1.Fields("REGNO"), rs1.Fields("REGNO"), "Female")
    End If
rs1.MoveNext
Wend
...
Cmd.ActiveConnection = Cn
Cmd.CommandText = "select * from student where REGNO='" & DId & "'"
