...
Begin VB.Form frmCourse 
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   840
      Width           =   5805
      Begin XPTEXTBOX.text txtCourse 
         Height          =   420
         Left            =   2220
         TabIndex        =   14
         Tag             =   "1"
...
Cmd.CommandText = "insert into course values(" & txtCourse.Text & ",'" & txtCname.Text & "','" & txtDept.Text & "')"
...
Cstring = "delete from course where course_id=" & txtCourse.Text
...
Cstring = "update course set cname ='" & txtCname.Text & "',dept='" & txtDept.Text & "' where course_id=" & txtCourse.Text
Cmd.CommandText = Cstring
MsgBox Cmd.CommandText
Cmd.Execute
Saved = True
...
rs1.Open "select * from course", Cn, adOpenDynamic
Saved = True
loaded = False
Screen.MousePointer = 99
Screen.MouseIcon = LoadPicture(App.Path & "\Themes\" & theme & "\Cursors\Arrow.cur")

Me.Caption = "Course DataBase"
...
txtCourse.Text = DRS.Fields(0)
Else
txtCourse.Text = ""
End If

If Not IsNull(DRS.Fields(1)) Then
txtCname.Text = DRS.Fields(1)
Else
txtCname.Text = ""
End If

If Not IsNull(DRS.Fields(2)) Then
txtDept.Text = DRS.Fields(2)
Else
txtDept.Text = ""
End If
...
txtCname.Text = StrConv(txtCname.Text, vbProperCase)
SendKeys "{END}"
End Sub
...
txtDept.Text = StrConv(txtDept.Text, vbProperCase)
SendKeys "{END}"
End Sub
