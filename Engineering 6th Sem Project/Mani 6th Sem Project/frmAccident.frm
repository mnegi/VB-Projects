...
Begin VB.Form frmAccident 
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   840
      Width           =   5805
      Begin XPTEXTBOX.text txtReportNo 
         Height          =   420
         Left            =   2250
         TabIndex        =   14
         Tag             =   "1"
      ...
      Begin XPTEXTBOX.text txtDate 
         ...
         EndProperty
      End
      Begin XPTEXTBOX.text txtLocation 
         Height          =   420
         Left            =   2235
         TabIndex        =   16
         Tag             =   "1"
...
txtDate.Text = Format(Now, "dd-mmm-yy")
...
Cmd.CommandText = "insert into ACCIDENT values('" & txtReportNo.Text & "','" & txtDate.Text & "','" & txtLocation.Text & "')"
...
Cstring = "delete from accident where REPORT_NO='" & txtReportNo.Text & "'"
...
txtReportNo.Locked = True
txtReportNo.BackColor = vbWhite
txtDate.Text = Format(txtDate.Text, "dd-mmm-yy")

Case 4
'Update
Cmd.ActiveConnection = Cn

Cstring = "update accident set ACC_DATE ='" & txtDate.Text & "',LOCATION='" & txtLocation.Text & "'"
Cmd.CommandText = Cstring
MsgBox Cmd.CommandText
Cmd.Execute
Saved = True
...
rs1.Open "select * from accident", Cn, adOpenDynamic
Saved = True
loaded = False
Screen.MousePointer = 99
Screen.MouseIcon = LoadPicture(App.Path & "\Themes\" & theme & "\Cursors\Arrow.cur")
...
txtReportNo.Text = DRS.Fields(0)
Else
txtReportNo.Text = ""
End If

If Not IsNull(DRS.Fields(1)) Then
txtDate.Text = DRS.Fields(1)
txtDate.Text = Format(txtDate.Text, "dd-mmm-yy")
Else
txtDate.Text = ""
End If
...
Private Sub txtReportNo_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then
txtDate.SetFocus
Else
