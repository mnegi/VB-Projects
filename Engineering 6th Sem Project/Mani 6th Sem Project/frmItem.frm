...
Cmd.CommandText = "insert into item values(" & txtItemNO.Text & "," & txtUprice.Text & ")"
...
Cstring = "delete from item where item_id=" & txtItemNO.Text
...
Cstring = "update item set uprice =" & txtUprice.Text & " where item_id=" & txtItemNO.Text
Cmd.CommandText = Cstring
MsgBox Cmd.CommandText
Cmd.Execute
Saved = True
...
rs1.Open "select * from item", Cn, adOpenDynamic
Saved = True
loaded = False
Screen.MousePointer = 99
Screen.MouseIcon = LoadPicture(App.Path & "\Themes\" & theme & "\Cursors\Arrow.cur")

Me.Caption = "Item DataBase"
