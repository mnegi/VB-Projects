...
txtSDate.Text = Format(Now, "dd-mmm-yy")
...
RsC.Open "select * from warehouse", Cn, adOpenStatic
cmbWareHouse.CLEAR
If RsC.EOF = True And RsC.BOF = True Then
MsgBox "You should have some warehouse nos."
Call btnEnable("10110111111")
Exit Sub
...
RsC.MoveFirst
While Not RsC.EOF
cmbWareHouse.AddItem RsC.Fields(0)
RsC.MoveNext
Wend
RsC.Close
End If
...
Cmd.CommandText = "insert into shipment values(" & cmbOrder.Text & "," & cmbWareHouse.Text & ",'" & txtSDate.Text & "')"
...
Cstring = "delete from shipment where s_order=" & cmbOrder.Text & " whouseno=" & cmbWareHouse.Text
...
cmbWareHouse.Locked = True
cmbWareHouse.BackColor = vbWhite

Case 4
'Update
Cmd.ActiveConnection = Cn

Cstring = "update shipment set ship_date ='" & txtSDate.Text & "' where s_order=" & cmbOrder.Text & " whouseno=" & cmbWareHouse.Text
Cmd.CommandText = Cstring
MsgBox Cmd.CommandText
Cmd.Execute
Saved = True
...
rs1.Open "select * from shipment", Cn, adOpenDynamic
Saved = True
loaded = False
Screen.MousePointer = 99
Screen.MouseIcon = LoadPicture(App.Path & "\Themes\" & theme & "\Cursors\Arrow.cur")

Me.Caption = "Shipment DataBase"
...
cmbWareHouse.AddItem DRS.Fields(1)
cmbWareHouse.Text = cmbWareHouse.List(0)
Else
'
End If

If Not IsNull(DRS.Fields(2)) Then
txtSDate.Text = Format(DRS.Fields(2), "dd-mmm-yy")
Else
txtSDate.Text = ""
End If
...
Sub Load_Records()
Cmd.ActiveConnection = Cn
Cmd.CommandText = "select * from shipment"
Set rs = Cmd.Execute
