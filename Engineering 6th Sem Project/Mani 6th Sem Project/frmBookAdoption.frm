...
Begin VB.Form frmBookAdoption 
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmBookAdoption.frx":000C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmBookAdoption.frx":0028
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmBookAdoption.frx":0044
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmBookAdoption.frx":0060
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmBookAdoption.frx":007C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmBookAdoption.frx":0098
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmBookAdoption.frx":00B4
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmBookAdoption.frx":00D0
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmBookAdoption.frx":00EC
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmBookAdoption.frx":0108
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmBookAdoption.frx":0124
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.Label lblTitle 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Book Adoption Database"
      BeginProperty Font 
         Name            =   "Times New Roman"
         Size            =   11.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmBookAdoption"
...
rsD.Open "select * from course", Cn, adOpenStatic
If Not (rsD.EOF = True And rsD.BOF = True) Then
rsD.MoveFirst
While Not rsD.EOF
cmbCourse.AddItem rsD.Fields(0)
rsD.MoveNext
Wend
rsD.Close
End If
...
cmbBookISBN.CLEAR
rsD.Open "select * from text", Cn, adOpenStatic
If Not (rsD.EOF = True And rsD.BOF = True) Then
rsD.MoveFirst
While Not rsD.EOF
cmbBookISBN.AddItem rsD.Fields(0)
rsD.MoveNext
Wend
rsD.Close
End If
...
Cmd.CommandText = "insert into book_adoption values(" & cmbCourse.Text & "," & cmbSem.Text & ",'" & cmbBookISBN.Text & "')"
...
Cstring = "delete from book_adoption where course=" & cmbCourse.Text
...
Cstring = "update book_adoption set sem =" & cmbSem.Text & ",book_isbn='" & cmbBookISBN.Text & "' where course=" & txtCourse.Text
Cmd.CommandText = Cstring
MsgBox Cmd.CommandText
Cmd.Execute
Saved = True
...
rs1.Open "select * from book_adoption", Cn, adOpenDynamic
Saved = True
loaded = False
Screen.MousePointer = 99
Screen.MouseIcon = LoadPicture(App.Path & "\Themes\" & theme & "\Cursors\Arrow.cur")

Me.Caption = "Book Adoption DataBase"
...
cmbCourse.AddItem DRS.Fields(0)
cmbCourse.Text = cmbCourse.List(0)
End If

cmbSem.CLEAR
If Not IsNull(DRS.Fields(1)) Then
cmbSem.AddItem DRS.Fields(1)
cmbSem.Text = cmbSem.List(0)
End If

cmbBookISBN.CLEAR
If Not IsNull(DRS.Fields(2)) Then
cmbBookISBN.AddItem DRS.Fields(2)
cmbBookISBN.Text = cmbBookISBN.List(0)
End If
...
Sub Load_Records()
Cmd.ActiveConnection = Cn
Cmd.CommandText = "select * from book_adoption"
Set rs = Cmd.Execute
