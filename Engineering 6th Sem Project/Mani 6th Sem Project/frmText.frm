...
Begin VB.Form frmText 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin XPTEXTBOX.text txtTitle 
         ...
         EndProperty
      End
      Begin XPTEXTBOX.text txtAuthor 
         Height          =   420
         Left            =   2265
         TabIndex        =   16
         Tag             =   "1"
...
Cmd.CommandText = "insert into text values('" & txtIsbn.Text & "','" & txtTitle.Text & "','" & txtPub.Text & "','" & txtAuthor.Text & "')"
...
Cstring = "delete from text where isbn='" & txtIsbn.Text & "'"
...
Cstring = "update text set title ='" & txtTitle.Text & "',publisher='" & txtPub.Text & "',author='" & txtAuthor.Text & "' where isbn='" & txtIsbn.Text & "'"
Cmd.CommandText = Cstring
MsgBox Cmd.CommandText
Cmd.Execute
Saved = True
...
rs1.Open "select * from text", Cn, adOpenDynamic
Saved = True
loaded = False
Screen.MousePointer = 99
Screen.MouseIcon = LoadPicture(App.Path & "\Themes\" & theme & "\Cursors\Arrow.cur")

Me.Caption = "Text Book DataBase"
