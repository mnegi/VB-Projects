...
Begin VB.Form frmOrderReports 
   ...
   Begin VB.Frame Frame6 
      ...
      Begin ManoharButton.MyButton MyButton5 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmOrderReports.frx":000C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.Frame Frame2 
      ...
      Begin ManoharButton.MyButton MyButton2 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmOrderReports.frx":0028
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.Frame Frame5 
      ...
      Begin ManoharButton.MyButton MyButton4 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmOrderReports.frx":0044
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.Frame Frame4 
      ...
      Begin ManoharButton.MyButton cmbPrintT 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmOrderReports.frx":0060
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.Frame Frame3 
      ...
      Begin ManoharButton.MyButton MyButton1 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmOrderReports.frx":007C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin VB.Label Label3 
         BackStyle       =   0  'Transparent
         Caption         =   $"frmOrderReports.frx":0098
         BeginProperty Font 
            Name            =   "Times New Roman"
            Size            =   11.25
            Charset         =   0
   ...
   Begin VB.Label lblTitle 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Order Processing DataBase - Report Generator"
      BeginProperty Font 
         Name            =   "Times New Roman"
         Size            =   11.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmOrderReports"
...
Case "Customer"
    DataEnvironment1.rscmdOCust.Close
    DataEnvironment1.cmdOCust
    dsrCustAll.Caption = "Report Generator - Customer Table"
    dsrCustAll.WindowState = 2
    dsrCustAll.Show
Case "Order"
    DataEnvironment1.rscmdOrder.Close
    DataEnvironment1.cmdOrder
    dsroOrders.Caption = "Report Generator - Order Table"
    dsroOrders.WindowState = 2
    dsroOrders.Show
Case "Order_Item"
    DataEnvironment1.rscmdOrderItem.Close
    DataEnvironment1.cmdOrderItem
    dsrOrderDetails.Caption = "Report Generator - Order Details Table"
    dsrOrderDetails.WindowState = 2
    dsrOrderDetails.Show
Case "Item"
    DataEnvironment1.rscmdItems.Close
    DataEnvironment1.cmdItems
    dsrItem.Caption = "Report Generator - Item Table"
    dsrItem.WindowState = 2
    dsrItem.Show
Case "Shipment"
    DataEnvironment1.rscmdShipment.Close
    DataEnvironment1.cmdShipment
    dsrShipment.Caption = "Report Generator - Shipment Table"
    dsrShipment.WindowState = 2
    dsrShipment.Show
Case "Warehouse"
    DataEnvironment1.rscmdWarehouse.Close
    DataEnvironment1.cmdWarehouse
    dsrWarehoude.Caption = "Report Generator - WareHouse Table"
    dsrWarehoude.WindowState = 2
    dsrWarehoude.Show
...
Screen.MousePointer = 99
Screen.MouseIcon = LoadPicture(App.Path & "\Themes\" & theme & "\Cursors\Arrow.cur")
Me.Caption = "Order Processing DataBase - Report Generator"
...
Sub loadTables()
cmbTables.CLEAR
cmbTables.AddItem "Customer"
cmbTables.AddItem "Order"
cmbTables.AddItem "Order_Item"
cmbTables.AddItem "Item"
cmbTables.AddItem "Shipment"
cmbTables.AddItem "Warehouse"
