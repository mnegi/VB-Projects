...
Begin VB.Form frmParticipated 
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmParticipated.frx":000C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmParticipated.frx":0028
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmParticipated.frx":0044
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmParticipated.frx":0060
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmParticipated.frx":007C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmParticipated.frx":0098
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmParticipated.frx":00B4
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmParticipated.frx":00D0
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmParticipated.frx":00EC
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmParticipated.frx":0108
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ManoharButton.MyButton Btns 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmParticipated.frx":0124
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.Label lblReport 
      ...
      Width           =   1545
   End
   Begin VB.Label lblDAmt 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Damage Amount"
      BeginProperty Font 
         Name            =   "Times New Roman"
         Size            =   11.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmParticipated"
...
rsp.Open "select * from ACCIDENT order by REPORT_NO", Cn, adOpenStatic
While Not rsp.EOF
cmbReportNo.AddItem rsp.Fields(0)
rsp.MoveNext
Wend
rsp.Close
cmbReportNo.Text = cmbReportNo.List(0)
...
Cmd.CommandText = "insert into PARTICIPATED values('" & cmbDriverId.Text & "','" & cmbRegno.Text & "','" & cmbReportNo.Text & "','" & txtDAmt.Text & "')"
...
Cstring = "delete from PARTICIPATED where DR_ID='" & cmbDriverId.Text & "' and REG_NUMB='" & cmbRegno.Text & "' AND REPORT_NUM='" & cmbReportNo.Text & "'"
...
Cstring = "update PARTICIPATED set REG_NUMB ='" & cmbRegno.Text & "',REPORT_NUM='" & cmbReportNo.Text & "',DAMAGE_AMOUNT='" & txtDAmt.Text & "' WHERE DR_ID='" & cmbDriverId.Text & "'"
Cmd.CommandText = Cstring
MsgBox Cmd.CommandText
Cmd.Execute
Saved = True
...
On Error GoTo q
rs1.Open "select * from PARTICIPATED", Cn, adOpenDynamic
Saved = True
loaded = False
Screen.MousePointer = 99
Screen.MouseIcon = LoadPicture(App.Path & "\Themes\" & theme & "\Cursors\Arrow.cur")
...
cmbReportNo.AddItem DRS.Fields(2)
cmbReportNo.Text = cmbReportNo.List(0)
End If

If Not IsNull(DRS.Fields(3)) Then
txtDAmt.Text = DRS.Fields(3)
Else
txtDAmt.Text = ""
End If
...
Sub Load_Records()
Cmd.ActiveConnection = Cn
Cmd.CommandText = "select * from PARTICIPATED"
Set rs = Cmd.Execute
