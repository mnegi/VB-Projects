...
Begin VB.Form frmBranch 
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   840
      Width           =   5805
      Begin XPTEXTBOX.text txtBranch 
         Height          =   420
         Left            =   2250
         TabIndex        =   14
         Tag             =   "1"
         ToolTipText     =   "Enter the branch name"
         Top             =   240
         Width           =   3435
         _ExtentX        =   6059
         _ExtentY        =   741
      ...
      Begin XPTEXTBOX.text txtCity 
         ...
         EndProperty
      End
      Begin XPTEXTBOX.text txtAssets 
         Height          =   420
         Left            =   2220
         TabIndex        =   19
         Tag             =   "1"
         ToolTipText     =   "Enter the assets"
         Top             =   1875
         Width           =   3435
         _ExtentX        =   6059
         _ExtentY        =   741
...
Cmd.CommandText = "insert into branch values('" & txtBranch.Text & "','" & txtCity.Text & "'," & txtAssets.Text & ")"
...
Cstring = "delete from branch where name='" & txtBranch.Text & "'"
...
Cstring = "update branch set city ='" & txtCity.Text & "',assets=" & txtAssets.Text & " where name='" & txtBranch.Text & "'"
Cmd.CommandText = Cstring
MsgBox Cmd.CommandText
Cmd.Execute
Saved = True
...
rs1.Open "select * from branch", Cn, adOpenDynamic
Saved = True
loaded = False
Screen.MousePointer = 99
Screen.MouseIcon = LoadPicture(App.Path & "\Themes\" & theme & "\Cursors\Arrow.cur")

Me.Caption = "Branch DataBase"
...
txtBranch.Text = DRS.Fields(0)
Else
txtBranch.Text = ""
End If

If Not IsNull(DRS.Fields(1)) Then
txtCity.Text = DRS.Fields(1)
Else
txtCity.Text = ""
End If

If Not IsNull(DRS.Fields(2)) Then
txtAssets.Text = DRS.Fields(2)
Else
txtAssets.Text = ""
End If
...
txtBranch.Text = StrConv(txtBranch.Text, vbProperCase)
SendKeys "{END}"
End Sub

Private Sub txtAssets_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then
'
Else
...
Private Sub txtBrach_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then
txtTitle.SetFocus
Else
Call CHARVALID(KeyAscii)
