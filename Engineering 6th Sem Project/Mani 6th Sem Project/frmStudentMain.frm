...
Begin VB.Form frmStudentMain 
   ...
   Begin VB.Label lblTitle 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Student DataBase Launcher"
      BeginProperty Font 
         Name            =   "Times New Roman"
         Size            =   11.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmStudentMain"
...
Screen.MousePointer = 99
Screen.MouseIcon = LoadPicture(App.Path & "\Themes\" & theme & "\Cursors\Arrow.cur")
Me.Caption = "Student Enrollment DataBase Launcher"
