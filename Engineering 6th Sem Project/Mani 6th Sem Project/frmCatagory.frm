...
Cmd.CommandText = "insert into category values(" & txtItemNO.Text & ",'" & txtUprice.Text & "')"
...
Cstring = "delete from category where category=" & txtItemNO.Text
...
Cstring = "update category set description ='" & txtUprice.Text & "' where category=" & txtItemNO.Text
Cmd.CommandText = Cstring
MsgBox Cmd.CommandText
Cmd.Execute
Saved = True
...
rs1.Open "select * from category", Cn, adOpenDynamic
Saved = True
loaded = False
Screen.MousePointer = 99
Screen.MouseIcon = LoadPicture(App.Path & "\Themes\" & theme & "\Cursors\Arrow.cur")

Me.Caption = "category DataBase"
