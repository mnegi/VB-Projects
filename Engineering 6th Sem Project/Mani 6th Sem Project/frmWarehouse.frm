...
Begin VB.Form frmWarehouse 
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   840
      Width           =   5805
      Begin XPTEXTBOX.text txtItemNO 
         Height          =   420
         Left            =   2250
         TabIndex        =   14
         Tag             =   "1"
         ...
         EndProperty
      End
      Begin XPTEXTBOX.text txtUprice 
         Height          =   420
         Left            =   2250
         TabIndex        =   15
         Tag             =   "1"
...
Cmd.CommandText = "insert into warehouse values(" & txtItemNO.Text & ",'" & txtUprice.Text & "')"
...
Cstring = "delete from warehouse where whouse=" & txtItemNO.Text
...
Cstring = "update warehouse set uprice ='" & txtUprice.Text & "' where whouse=" & txtItemNO.Text
Cmd.CommandText = Cstring
MsgBox Cmd.CommandText
Cmd.Execute
Saved = True
...
rs1.Open "select * from warehouse", Cn, adOpenDynamic
Saved = True
loaded = False
Screen.MousePointer = 99
Screen.MouseIcon = LoadPicture(App.Path & "\Themes\" & theme & "\Cursors\Arrow.cur")

Me.Caption = "warehouse DataBase"
...
txtItemNO.Text = DRS.Fields(0)
Else
ItemNO.Text = ""
End If

If Not IsNull(DRS.Fields(1)) Then
txtUprice.Text = DRS.Fields(1)
Else
txtUprice = ""
End If
...
txtUprice.Text = StrConv(txtUprice.Text, vbProperCase)
SendKeys "{END}"
